[GoGo Protobuf looking for new ownership](https://github.com/ypenghui6/protobuf/issues/691)

# Protocol Buffers for Go with Gadgets

[![Build Status](https://github.com/ypenghui6/protobuf/workflows/Continuous%20Integration/badge.svg)](https://github.com/ypenghui6/protobuf/actions)
[![GoDoc](https://godoc.org/github.com/ypenghui6/protobuf?status.svg)](http://godoc.org/github.com/ypenghui6/protobuf)
...
<a href="https://github.com/ypenghui6/protobuf/issues/191">issue</a>

## Release v1.3.0

The project has updated to release v1.3.0. Check out the release notes <a href="https://github.com/ypenghui6/protobuf/releases/tag/v1.3.0">here</a>.
...
Install the protoc-gen-gofast binary
    ...
    go get github.com/ypenghui6/protobuf/protoc-gen-gofast

Use it to generate faster marshaling and unmarshaling go code for your protocol buffers.

    protoc --gofast_out=. myproto.proto

This does not allow you to use any of the other gogoprotobuf [extensions](https://github.com/ypenghui6/protobuf/blob/master/extensions.md).
...
Installing any of these binaries is easy.  Simply run:
    ...
    go get github.com/ypenghui6/protobuf/proto
    go get github.com/ypenghui6/protobuf/{binary}
    go get github.com/ypenghui6/protobuf/gogoproto

These binaries allow you to use gogoprotobuf [extensions](https://github.com/ypenghui6/protobuf/blob/master/extensions.md). You can also use your own binary.

To generate the code, you also need to set the include path properly.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/ypenghui6/protobuf/protobuf --{binary}_out=. myproto.proto

To use proto files from "google/protobuf" you need to add additional args to protoc.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/ypenghui6/protobuf/protobuf --{binary}_out=\
    Mgoogle/protobuf/any.proto=github.com/ypenghui6/protobuf/types,\
    Mgoogle/protobuf/duration.proto=github.com/ypenghui6/protobuf/types,\
    Mgoogle/protobuf/struct.proto=github.com/ypenghui6/protobuf/types,\
    Mgoogle/protobuf/timestamp.proto=github.com/ypenghui6/protobuf/types,\
    Mgoogle/protobuf/wrappers.proto=github.com/ypenghui6/protobuf/types:. \
    myproto.proto
...
Please visit the [extensions](https://github.com/ypenghui6/protobuf/blob/master/extensions.md) page for more documentation.

Install protoc-gen-gogo:

    go get github.com/ypenghui6/protobuf/proto
    go get github.com/ypenghui6/protobuf/jsonpb
    go get github.com/ypenghui6/protobuf/protoc-gen-gogo
    go get github.com/ypenghui6/protobuf/gogoproto
